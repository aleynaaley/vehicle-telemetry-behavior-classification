...
# metrikleri kaydet
with open(f"{save_path}/naive_bayes_metrics.txt", "w", encoding="utf-8") as f:
    f.write("Naive Bayes Model Sonuçları\n")
    f.write("=" * 40 + "\n\n")
...
print("\nMetrikler kaydedildi -> outputs/naive_bayes/naive_bayes_metrics.txt")
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig(f"{save_path}/naive_bayes_confusion_matrix.png")

print("Confusion matrix kaydedildi -> outputs/naive_bayes/naive_bayes_confusion_matrix.png")

# modeli kaydet
joblib.dump(model, f"{save_path}/naive_bayes_model.pkl")
print("Model kaydedildi -> outputs/naive_bayes/naive_bayes_model.pkl")
