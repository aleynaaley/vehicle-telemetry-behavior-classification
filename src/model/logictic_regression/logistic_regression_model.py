...
# kayıt klasörü
save_path = "../../../outputs/logistic_regression"
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig(f"{save_path}/logistic_regression_confusion_matrix.png")
print("Confusion matrix kaydedildi -> outputs/logistic_regression/logistic_regression_confusion_matrix.png")

# modeli kaydet
joblib.dump(model, f"{save_path}/logistic_regression_model.pkl")
print("Model kaydedildi -> outputs/logistic_regression/logistic_regression_model.pkl")
