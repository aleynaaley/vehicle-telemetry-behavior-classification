...
# kayıt klasörü
save_path = "../../../outputs/decision_tree"
...
with open(f"{save_path}/decision_tree_metrics.txt", "w", encoding="utf-8") as f:
    f.write("Decision Tree Model Sonuçları\n")
    f.write("=" * 40 + "\n\n")
...
print("\nMetrikler kaydedildi -> outputs/decision_tree/decision_tree_metrics.txt")
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig(f"{save_path}/decision_tree_confusion_matrix.png")

print("Confusion matrix kaydedildi -> outputs/decision_tree/decision_tree_confusion_matrix.png")

# modeli kaydet
joblib.dump(model, f"{save_path}/decision_tree_model.pkl")
print("Model kaydedildi -> outputs/decision_tree/decision_tree_model.pkl")
