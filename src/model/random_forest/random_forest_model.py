...
with open(f"{save_path}/random_forest_metrics.txt", "w", encoding="utf-8") as f:
...
# modeli kaydet
joblib.dump(model, f"{save_path}/random_forest_model.pkl")
print("Model kaydedildi -> outputs/random_forest/random_forest_model.pkl")
